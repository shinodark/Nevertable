...
<?php
   ...
   while ($fields = $this->table->db->FetchArray($records))
   {
      ...
      <td><a href="index.php?levelset_f=<?php echo $fields['levelset']."&amp;level_f=".$fields['level']?>&amp;folder=-1&amp;type=<?php echo $fields['type'] ?>"><?php echo $fields['level'] ?></a></td>
      ...
      <a href="index.php?levelset_f=<?php echo  $fields['levelset']."&amp;level_f=".$fields['level']?>&amp;folder=-1&amp;type=<?php echo $fields['type']?>" title="<?php echo $lang['TABLE_ATTACH'] ?>">
