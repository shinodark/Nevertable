...
<?php
echo "<script type=\"text/javascript\">setTextArea(opener.document.forms['".$_GET['referer_form']."'].content)</script>";
$mes = "";
foreach($toolbar_el as $key => $func)
{
 $mes .=  "<a href=\"javascript:".$func."()\">".$table->style->GetIcon($key)."</a>";
}
echo $mes;
?>
</center></td></tr>
