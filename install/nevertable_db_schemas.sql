...
INSERT INTO `nvrtbl_conf` (`conf_name`, `conf_value`, `conf_desc`) VALUES ('replay_dir', 'public/data/replays/', NULL);
INSERT INTO `nvrtbl_conf` (`conf_name`, `conf_value`, `conf_desc`) VALUES ('shot_dir', 'public/data/levelshots/', NULL);
INSERT INTO `nvrtbl_conf` (`conf_name`, `conf_value`, `conf_desc`) VALUES ('avatar_dir', 'public/data/avatars/', NULL);
INSERT INTO `nvrtbl_conf` (`conf_name`, `conf_value`, `conf_desc`) VALUES ('image_dir', 'public/images/', NULL);
INSERT INTO `nvrtbl_conf` (`conf_name`, `conf_value`, `conf_desc`) VALUES ('smilies_dir', 'public/smilies/', NULL);
INSERT INTO `nvrtbl_conf` (`conf_name`, `conf_value`, `conf_desc`) VALUES ('theme_dir', 'public/themes/', NULL);
