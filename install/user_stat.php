...
<?php
  ...
  {
    $u->LoadFromId($val['id']);
    $total_records = $u->_RecountTotalRecords();
    $best_records  = $u->_RecountBestRecords();
    $comments  = $u->_RecountComments();
    echo "User #".$val['id']." -=> total: ".$total_records . " -=- best : ".$best_records." -=- comments: ".$comments."<br/>\n";
  }
?>
</div><!-- fin "main" -->
